...
rm /etc/$raycheck/$userna-tls.json > /dev/null 2>&1
rm /etc/$raycheck/$userna-none.json > /dev/null 2>&1
echo "$userna 365Days VMESS | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="Link : \n<code>$trojanlink</code>\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days TROJAN | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="Wireguard	: http://$domain:81/$userna.conf\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days WIREGUARD | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="<code>$linkss2</code>\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days SHADOWSOCKS | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="<code>$ssr_link</code>\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days SHADOWSOCKS-R | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="Cert : http://$IPs:81/server.crt\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days SSTP | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="IPsec PSK : myvpn\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days L2TP | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="Expired On : $data 🗓 \n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days PPTP | ${message_from_username}" >> /etc/.maAsiss/log_res
...
env_msg+="<code>$linktrgo</code>\n"
env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
echo "$userna 365Days TROJAN-GO | ${message_from_username}" >> /etc/.maAsiss/log_res
